...
// Variant-specific overrides for accent colors
const variantAccentClasses: Record<Variant, string> = {
 dev: "", // Uses default white accent
 product:
  "data-[variant=product]:bg-blue-500 data-[variant=product]:hover:bg-blue-600",
 design:
  "data-[variant=design]:bg-purple-500 data-[variant=design]:hover:bg-purple-600",
 data:
  "data-[variant=data]:bg-green-500 data-[variant=data]:hover:bg-green-600",
 devops:
  "data-[variant=devops]:bg-orange-500 data-[variant=devops]:hover:bg-orange-600",
};
