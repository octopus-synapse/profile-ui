/**
 * Box - Primitive Type Contract
 *
 * @principle Single Responsibility
 * @layer Domain (Contract)
 *
 * Box is the foundational layout primitive.
 * All other components should extend from Box, not raw HTML/RN elements.
 */
...
export type BoxAs = "div" | "span" | "section" | "article" | "main" | "aside" | "header" | "footer" | "nav";
